...
const TOOL_MAP = {
  finance:  [
    ...
    { name: "Income Tax Calc",      href: "/tools/income-tax-calculator",         icon: "📊" },
    { name: "FD Calculator",        href: "/tools/fd-calculator",                 icon: "🏧" },
    { name: "Retirement Planner",   href: "/tools/retirement-calculator",         icon: "🌅" },
  ],
  health:   [
    { name: "BMI Calculator",       href: "/tools/bmi-calculator",                icon: "⚖️"  },
    { name: "Calorie Calculator",   href: "/tools/calorie-calculator",            icon: "🔥" },
    { name: "Water Intake",         href: "/tools/water-intake",                  icon: "💧" },
    { name: "Ideal Weight",         href: "/tools/ideal-weight",                  icon: "🏃" },
  ],
  content:  [
  ...
  teacher:  [
    { name: "Lesson Plan",          href: "/tools/teacher/lesson-plan-generator", icon: "📋" },
    { name: "MCQ Maker",            href: "/tools/teacher/mcq-maker",             icon: "✅" },
    { name: "Hindi Essay",          href: "/tools/teacher/hindi-essay-writer",    icon: "🇮🇳" },
  ],
  civil:    [
    { name: "House Floor Plan",     href: "/tools/civil/house-floor-plan-generator", icon: "🏠" },
    { name: "Concrete Mix Calc",    href: "/tools/concrete-mix-calculator",       icon: "🏗️"  },
    { name: "Steel Bar Weight",     href: "/tools/civil/steel-bar-weight-calculator", icon: "⚖️" },
  ],
  spiritual:[
    { name: "Prayer Generator",     href: "/tools/priest/prayer-generator",       icon: "🙏" },
    { name: "Bible Verse Finder",   href: "/tools/priest/bible-verse-finder",     icon: "✝️"  },
    { name: "Sermon Builder",       href: "/tools/priest/sermon-builder",         icon: "📖" },
  ],
};
